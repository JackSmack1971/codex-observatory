...
export type AdminCostSummary = { provenance: AdminProvenance; interval: AdminInterval; health: AdminHealth; totals: AdminCostTotal[]; result_count: number; latest_bucket: AdminBucket; groups: AdminGroup[] }
