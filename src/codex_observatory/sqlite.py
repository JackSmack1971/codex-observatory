...
MIGRATIONS: tuple[tuple[int, str], ...] = (
    ...
    (11, """
        CREATE TABLE openai_costs (
            result_identity TEXT NOT NULL, revision INTEGER NOT NULL, source TEXT NOT NULL,
            evidence_scope TEXT NOT NULL, bucket_start INTEGER NOT NULL, bucket_end INTEGER NOT NULL,
            bucket_width TEXT NOT NULL, project_id TEXT, line_item TEXT, api_key_id TEXT,
            amount_value TEXT, currency TEXT, quantity_value TEXT, quantity_unit TEXT,
            request_start INTEGER NOT NULL, request_end INTEGER NOT NULL, retrieved_at TEXT NOT NULL,
            adapter_schema_version TEXT NOT NULL, result_sha256 TEXT NOT NULL,
            first_observed_at TEXT NOT NULL, last_observed_at TEXT NOT NULL,
            is_current INTEGER NOT NULL CHECK(is_current IN (0,1)), PRIMARY KEY(result_identity, revision)
        );
        CREATE INDEX idx_openai_costs_current ON openai_costs(bucket_start, result_identity) WHERE is_current=1;
        CREATE TABLE openai_cost_sync_state (
            collector TEXT PRIMARY KEY, status TEXT NOT NULL, requested_start INTEGER, requested_end INTEGER,
            completed_start INTEGER, completed_end INTEGER, page_cursor TEXT, last_success TEXT, last_error TEXT,
            pages_total INTEGER NOT NULL DEFAULT 0, buckets_total INTEGER NOT NULL DEFAULT 0, updated_at TEXT NOT NULL
        );"""),
    (12, """
        CREATE TABLE openai_cost_sync_lock (
